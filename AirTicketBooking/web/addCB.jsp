                ...
                <div class="table-wrapper">
                    <div class="table-title">
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <button  class="btn btn-success" data-toggle="modal" name="submit" value="submit"><i class="material-icons">&#xE147;</i> <span>Add New Employee</span></button>
                    ...
                    <table class="table table-striped table-hover">
                        <thead>
                            <tr>                           
                                <th>Tên Hãng</th>
                                <th>
                                    <input type="text" list="tenhang" name="name" required=""/>
                                    <datalist id="tenhang">
                            ...
                            <tr>                           
                                <th>Mã máy bay</th>
                                <th>
                                    <input type="text" list="MB" name="idMB" required=""/>
                                    <datalist id="MB">
                            ...
                            <tr>                           
                                ...
                                <th><input type="text" name="localFrom" required=""></th>                            
                            </tr>
                            <tr>                           
                                <th>Điểm đến</th>
                                <th><input type="text" name="localTo" required=""></th>                            
                            </tr>
                            <tr>                           
                                <th>Thời gian khởi hành</th>
                                <th><input type="text" id="time1"   name="timeFrom" placeholder="" required=""></th>                            
                            </tr>
                            <tr>                           
                                <th>Thời gian đến</th>
                                <th><input type="text" id="time2"   name="timeTo" placeholder="" required=""></th>                            
                            </tr>
                            <tr>                           
                                <th>Tổng số ghế</th>
                                <th><input type="number" name="total_seat" required=""></th>                            
                            </tr>
                        </thead>
                        <tbody>
