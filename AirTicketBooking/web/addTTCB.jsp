            ...
            <form action="EditThongTinChuyenBay" method="post">
                ...
                <div class="table-wrapper">
                    <div class="table-title">
                        <div class="row">
                            <div class="col-sm-6">
                                <h2>Thêm mới <b>Thông tin chuyến bay</b></h2>
                    ...
                    <table class="table table-striped table-hover">
                        <thead>
                            ...
                            <tr>                           
                                ...
                                <th><input type="date" name="dateFrom" min="${dateTime}"></th>                            
                            </tr>
                            <tr>                           
                                <th>Giá vé(K)</th>
                                <th><input type="number" name="price" required="" placeholder="VD: 999K"></th>                            
                            </tr>
                            <tr>                           
