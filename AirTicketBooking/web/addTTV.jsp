    ...
    <body>
        ...
        <div class="container">
            ...
            <form action="EditThongTinVe" method="post">
                <input hidden="" name="go" value="add">
                <div class="table-wrapper">
                    <div class="table-title">
                        <div class="row">
                            <div class="col-sm-6">
                                <h2>Thêm mới <b>Thông tin vé</b></h2>
                                <h3 style="color: red">${ms}</h3>
                            </div>
                            <div class="col-sm-6">
                                <button  class="btn btn-success" data-toggle="modal" name="submit" value="submit"><i class="material-icons">&#xE147;</i> <span>Thêm mới</span></button>
                    ...
                    <table class="table table-striped table-hover">
                        <thead>
                            <tr>                           
                                <th>Mã hành khách</th>
                                <th>
                                    <input type="number" list="idHK" name="idHK" required=""/>
                                    <datalist id="idHK">
                            ...
                            <tr>                           
                                <th>Mã chuyến bay</th>
                                <th>
                                    <input type="number" list="idCB" name="idCB" required=""/>
                                    <datalist id="idCB">
                            ...
                            <tr>                           
                                ...
                                <th>
                                    <input type="text" list="dateFrom" name="dateFrom" required=""/>
                            ...
                            <tr>                           
                                <th>Người Lớn</th>
                                <th><input type="number" name="NL" required="" placeholder=""></th>                            
                            </tr>
                            <tr>                           
                                <th>Trẻ em</th>
                                <th><input type="number" name="TE" required="" placeholder=""></th>                            
                            </tr>
                            <tr>                           
                                <th>Em bé</th>
                                <th><input type="number" name="EB" required="" placeholder=""></th>                            
                            </tr>
