                    ...
                    <div class="card-body" >
                        <form action="account" method="post">
                            ...
                            <div class="input-group form-group">
                                ...
                                <input type="text" class="form-control" id="username" name="user" placeholder="Nhập tên tài khoản">
                            </div>
                            <div class="input-group form-group">
                                <div class="input-group-prepend">
                                    <span class="input-group-text"><i class="fas fa-key"></i></span>
                                </div>
                                <input type="password" class="form-control" id="" name="oldPass" placeholder="Mật khẩu cũ">
                            </div>
                            <div class="input-group form-group">
                                <div class="input-group-prepend">
                                    <span class="input-group-text"><i class="fas fa-key"></i></span>
                            ...
                            <div class="input-group form-group">
                                ...
                                <input type="password" class="form-control" id="confirm_password" name="newPass" placeholder="Nhập lại mật khẩu"> <br>
                            ...
                            <div class="form-group">
                                <input type="" id="btn-signUp" readonly="" name="submit" value="Xác nhận" class="btn float-right login_btn">
                            </div>
                        </form>
                    </div>
