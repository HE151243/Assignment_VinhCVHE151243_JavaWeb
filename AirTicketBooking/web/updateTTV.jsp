                    ...
                    <div class="table-title">
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                ...
                                <a href="EditThongTinVe" class="btn btn-danger" ><i class="material-icons arrow_circle_left">&#xeaa7;</i> <span>Trở lại</span></a>
                            </div>
                        </div>
                    </div>
                    <table class="table table-striped table-hover">
                        <thead>
                            <tr>                           
                                <th>Mã vé</th>
                                <th>
                                    <input type="number" name="id" readonly=""  value="${ve.mave}" placeholder="${ve.mave}"/>
                                </th>                            
                            </tr>
                            <tr>                           
                                <th>Mã hành khách</th>
                                <th>
                                    <input type="number" list="idHK" name="idHK" required="" placeholder="${ve.mahanhkhach}"/>
                                    <datalist id="idHK">
                                        <c:forEach var="id" items="${lidHK}">
                                            <option>${id}</option>
                                        </c:forEach>
                                    </datalist>
                                </th>                            
                            ...
                            <tr>                           
                                <th>Mã chuyến bay</th>
                                <th>
                                    <input type="number" list="idCB" name="idCB" required="" placeholder="${ve.machuyenbay}"/>
                                    <datalist id="idCB">
                                        <c:forEach var="id" items="${lidCB}">
                                            <option>${id}</option>
                                        </c:forEach>
                                    </datalist>
                                </th>                            
                            ...
                            <tr>                           
                                ...
                                <th>
                                    <input type="text" list="dateFrom" name="dateFrom" required="" placeholder="${ve.ngaykhoihanh}"/>
                                    <datalist id="dateFrom">
                                        <c:forEach var="d" items="${ld}">
                                            <option>${d}</option>
                                        </c:forEach>
                                    </datalist>
                                </th>                            
                            ...
                            <tr>                           
                                <th>Người Lớn</th>
                                <th><input type="number" name="NL" required="" placeholder="${ve.NL}"></th>                            
                            </tr>
                            <tr>                           
                                <th>Trẻ em</th>
                                <th><input type="number" name="TE" required="" placeholder="${ve.TE}"></th>                            
                            </tr>
                            <tr>                           
                                <th>Em bé</th>
                                <th><input type="number" name="EB" required="" placeholder="${ve.EB}"></th>                            
                            </tr>
                        </thead>
                        <tbody>
